...
import { Home, LogOut, Heart, Calculator, MessageCircle, X, Search, BarChart as BarChartIcon } from 'lucide-react';
    ...
    <div className="dashboard">
      <nav className="navbar">
        ...
        <div className="navbar-actions">
          <Link to="/favourites" className="nav-icon-btn">
            <Heart size={20} /> <font color = "white"> Favorites</font>
            {favourites.length > 0 && (
              <span className="badge">{favourites.length}</span>
            )}
          </Link> &nbsp;
          <Link to="/emi-calculator" className="nav-icon-btn">
            <Calculator size={20} /> <font color = "white">EMI Calculator</font>
          </Link><br></br>
